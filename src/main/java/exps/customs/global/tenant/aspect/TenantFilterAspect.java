package exps.customs.global.tenant.aspect;
...
public class TenantFilterAspect {
    ...
    @Around("@annotation(exps.customs.global.tenant.aspect.TenantFiltered) || @within(exps.customs.global.tenant.aspect.TenantFiltered)")
