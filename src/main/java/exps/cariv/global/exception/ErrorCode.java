...
public enum ErrorCode {
    ...
    REQUIRED_DOCUMENT_MISSING(HttpStatus.BAD_REQUEST, "REQUIRED_DOCUMENT_MISSING", "필수 서류가 누락되었습니다."),
    REQUIRED_DATA_MISSING(HttpStatus.BAD_REQUEST, "REQUIRED_DATA_MISSING", "필수 데이터가 누락되었습니다."),
    REQUIRED_DOC_AND_DATA_MISSING(HttpStatus.BAD_REQUEST, "REQUIRED_DOC_AND_DATA_MISSING", "필수 서류/데이터가 누락되었습니다."),
    ...
    SHIPPER_NOT_FOUND(HttpStatus.NOT_FOUND, "SHIPPER_NOT_FOUND", "화주 정보를 찾을 수 없습니다."),
